        ...
        for i in range(self.__model.getSize()[1]):
            for j in range(self.__model.getSize()[0]):
                if((i,j) in self.__model.getCrateOnStar()):
                    ...
                    self.__gridLabel[counter].setStyleSheet("background-color : purple; color : white;")
                elif(len(self.__model.getTeleport()) != 0 and (i,j) == self.__model.getTeleport()[1]):
                    self.__gridLabel[counter].setStyleSheet("background-color : pink; color : white;")  
                    ...
                    self.__gridLabel[counter].setStyleSheet("background-color : skyblue; color : white;")
                elif((i,j) in self.__model.getTraps()):
                    self.__gridLabel[counter].setStyleSheet("background-color : #ff3d3d; color : white;")
